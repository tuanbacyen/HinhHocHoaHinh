<%@ Page Title="" Language="C#" MasterPageFile="~/formHienThi/MasterPage.Master" AutoEventWireup="true" CodeBehind="frm_BaiToanBieuDien.aspx.cs" Inherits="HinhHocHoaHinh.frm_BaiToanBieuDien" %>
...
<ItemStyle Width="5px"></ItemStyle>
        ...
        <asp:HyperLinkField DataTextField="tomtat" DataNavigateUrlFields="id" DataNavigateUrlFormatString="~//formHienThi/frm_BaiToanBieuDien.aspx?ma={0}" ItemStyle-Width = "150" >
