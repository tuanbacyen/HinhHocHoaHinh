<%@ Page Title="" Language="C#" MasterPageFile="~/formHienThi/MasterPage.Master" AutoEventWireup="true" CodeBehind="frm_DaiCuongVePhepChieu.aspx.cs" Inherits="HinhHocHoaHinh.frm_DaiCuongVePhepChieu" %>
...
<ItemStyle Width="5px"></ItemStyle>
        ...
        <asp:HyperLinkField DataTextField="tomtat" DataNavigateUrlFields="id" DataNavigateUrlFormatString="~//formHienThi/frm_DaiCuongVePhepChieu.aspx?ma={0}" ItemStyle-Width = "150" >
