<%@ Page Title="" Language="C#" MasterPageFile="~/formHienThi/MasterPage.Master" AutoEventWireup="true" CodeBehind="frm_BaiToanGiao.aspx.cs" Inherits="HinhHocHoaHinh.frm_BaiToanGiao" %>
...
<ItemStyle Width="5px"></ItemStyle>
        ...
        <asp:HyperLinkField DataTextField="tomtat" DataNavigateUrlFields="id" DataNavigateUrlFormatString="~//formHienThi/frm_BaiToanGiao.aspx?ma={0}" ItemStyle-Width = "150" >
